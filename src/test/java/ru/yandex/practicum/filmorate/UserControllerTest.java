...
class UserControllerTest {
    ...
    void setUp() {
        ...
        validUser = new User(0L, "valid@example.com", "valid_login", "Valid User",
    ...
    void create_WithEmptyUser_ShouldThrowValidationException() {
        ...
        ValidationException exception = assertThrows(
                ...
                "Ожидалось ValidationException при пустом пользователе!"
        );
    ...
    void create_WithInvalidUserShouldThrowValidationException() {
        User emptyUser = new User(0L, "asddas", "dS sas", "",
                LocalDate.of(2040, 1, 1));
        ValidationException exception = assertThrows(
                ValidationException.class,
                () -> userController.create(emptyUser),
                "Ожидалось ValidationException при неверных данных"
        );
